...
<div class="super-container">
    <div class="home">
		...
		<!-- <div class="home" data-image-src="{{ asset('images/building_block.png') }}"></div> -->
		<img src="{{ asset('images/building_block.png') }}">
									...
									<div class="row" style="margin-bottom:30px;">
										<div class="col-lg-12 grouped_col">
											<div class="flex-row align-items-center justify-content-center">
												...
												@csrf
												@method('PUT')
													<label for="desc">Título da lição:</label><span class="mandatory"> *</span>
													<input type="text" id="desc" name="name" style="height:100px; width:100%;" value="{{$lesson->name}}">
													...
													@else
													<label class="radio-inline"><input type="radio" style="width:50px;" name="is_active" value="0">Inactiva</label>
													<label class="radio-inline"><input type="radio" style="width:50px;" name="is_active" value="1" checked>Activa</label>
													@endif
														<div class="d-flex flex-row align-item-center justify-content-center">
															<input type="submit" style="width:150px;" id="lesson_form_submit" value="Guardar questão">
														</div>
												</form>
											</div>
										</div>
											...
											<div class="flex-row align-items-center justify-content-center">
												...
												@csrf
													...
													<div class="d-flex flex-row align-items-center justify-content-center">
														<input type="submit" style="width:150px;" id="option_form_submit" value="Criar respostas">
													</div>
												@else
													...
													@foreach($question->question_options as $question_option)
														<div class="panel panel-default">
															<div class="panel-body">
																<label for="fname{{$question_option->id}}">Opção de resposta {{$question_option->id}}:</label><span class="mandatory"> *</span>
																<input type="text" id="fname{{$question_option->id}}" name="body" value="{{$question_option->body}}">
																@if($question_option->is_active==0)
																<label class="radio-inline"><input type="radio" name="is_active{{$question_option->id}}" style="width:50px;" value="0" checked>Inactiva</label>
																<label class="radio-inline"><input type="radio" name="is_active{{$question_option->id}}" style="width:50px;" value="1">Activa</label>
																@else
																<label class="radio-inline"><input type="radio" name="is_active{{$question_option->id}}" style="width:50px;" value="0">Inactiva</label>
																<label class="radio-inline"><input type="radio" name="is_active{{$question_option->id}}" style="width:50px;" value="1" checked>Activa</label>
																@endif
															</div>
														</div>
													@endforeach
													<div class="d-flex flex-row align-items-center justify-content-center">
														<input type="submit" style="width:150px;" id="option_form_submit" value="Guardar respostas">
													</div>
												@endif
												</form>
											</div>
